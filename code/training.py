...
parser.add_argument('--train_batch_size', required=False, default=128)
parser.add_argument('--val_batch_size', required=False, default=32)
...
parser.add_argument('--data_loader_num_workers', required=False, default=16)
...
parser.add_argument('--crop_size', required=False, default=512)
